...
const FoodCategory = () => {
  ...
  const items = [
    { id: 1, img: "/images/foodc1.png", label: "Save 50% on Fast Food" },
    { id: 2, img: "/images/foodc2.png", label: "Delicious Burgers" },
    { id: 3, img: "/images/foodc3.png", label: "Healthy Salads" },
    { id: 4, img: "/images/foodc4.png", label: "Desserts" },
  ];
